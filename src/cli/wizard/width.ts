...
const WIZARD_MIN_WIDTH = 56;
const WIZARD_MAX_WIDTH = 80;
const FALLBACK_THRESHOLD = 50;

// Wizard outer width given the terminal width. Subtracts 4 cols of
// breathing room (2 cols margin on each side) and clamps to the
// readable range.
